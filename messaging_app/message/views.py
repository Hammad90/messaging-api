...
class GetMessagesAPIView(APIView):
    def get(self, request: Request):
        ...
        for message in chat_messages:
            ...
            chat_messages_dict[chat_id].append(
        ...
        for message  in group_messages:
            ...
            group_messages_dict[group_id].append(
                MessageSerializer(message).data
            )
        ...
        response_date = {
            'messages': {
                'chats': [
                    {'chat_id': chat_id, 'messages': messages} for chat_id, messages in chat_messages_dict.items()
                ],
                'groups': [
                    {'group_id': group_id, 'messages': messages} for group_id, messages in group_messages_dict.items()
                ]
            }
        }
